...
class ConsumerClient implements \com\ndpmedia\rocketmq\babel\ConsumerIf {
  ...
  public function send_consume()
  {
    $args = new \com\ndpmedia\rocketmq\babel\Consumer_consume_args();
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  public function recv_consume()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\com\ndpmedia\rocketmq\babel\Consumer_consume_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \com\ndpmedia\rocketmq\babel\Consumer_consume_result();
...
class Consumer_consume_args {
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('Consumer_consume_args');
    $xfer += $output->writeFieldStop();
    $xfer += $output->writeStructEnd();
    return $xfer;
  }
...
class Consumer_consume_result {
  ...
  public function getName() {
    return 'Consumer_consume_result';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('Consumer_consume_result');
    $xfer += $output->writeFieldStop();
    $xfer += $output->writeStructEnd();
    return $xfer;
  }
