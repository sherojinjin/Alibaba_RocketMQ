...
public class Consumer {
  ...
  public interface Iface {
    ...
    public List<MessageExt> pull() throws TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_pull() throws TException
    {
      pull_args args = new pull_args();
      sendBase("pull", args);
    }

    public List<MessageExt> recv_pull() throws TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class pull_call extends org.apache.thrift.async.TAsyncMethodCall {
      public pull_call(AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
      ...
      public List<MessageExt> getResult() throws TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class pull<I extends Iface> extends org.apache.thrift.ProcessFunction<I, pull_args> {
      ...
      public pull_result getResult(I iface, pull_args args) throws TException {
        pull_result result = new pull_result();
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class pull<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, pull_args, List<MessageExt>> {
      ...
      public void start(I iface, pull_args args, AsyncMethodCallback<List<MessageExt>> resultHandler) throws TException {
...
;
    ...
    private static class pull_argsStandardScheme extends StandardScheme<pull_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, pull_args struct) throws TException {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, pull_args struct) throws TException {
        struct.validate();
    ...
    private static class pull_argsTupleScheme extends TupleScheme<pull_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, pull_args struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
      }

      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, pull_args struct) throws TException {
  ...
  public static class pull_result implements org.apache.thrift.TBase<pull_result, pull_result._Fields>, java.io.Serializable, Cloneable, Comparable<pull_result>   {
    ...
    private static class pull_resultStandardScheme extends StandardScheme<pull_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, pull_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<MessageExt>(_list0.size);
                  MessageExt _elem1;
                  for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                  {
                    _elem1 = new MessageExt();
                    _elem1.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, pull_result struct) throws TException {
        struct.validate();
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (MessageExt _iter3 : struct.success)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class pull_resultTupleScheme extends TupleScheme<pull_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, pull_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (MessageExt _iter4 : struct.success)
            {
              _iter4.write(oprot);
            }
          }
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, pull_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          {
            org.apache.thrift.protocol.TList _list5 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
            struct.success = new ArrayList<MessageExt>(_list5.size);
            MessageExt _elem6;
            for (int _i7 = 0; _i7 < _list5.size; ++_i7)
            {
              _elem6 = new MessageExt();
              _elem6.read(iprot);
