...
import com.ndpmedia.rocketmq.lsr.common.ClientCommand;
import com.ndpmedia.rocketmq.lsr.common.ClientReply;
import com.ndpmedia.rocketmq.lsr.common.nio.PacketHandler;
import com.ndpmedia.rocketmq.lsr.common.nio.ReaderAndWriter;
import com.ndpmedia.rocketmq.lsr.common.nio.SelectorThread;
import com.ndpmedia.rocketmq.lsr.paxos.idgen.IdGenerator;
import com.ndpmedia.rocketmq.lsr.paxos.idgen.IdGeneratorType;
import com.ndpmedia.rocketmq.lsr.paxos.idgen.SimpleIdGenerator;
import com.ndpmedia.rocketmq.lsr.paxos.idgen.TimeBasedIdGenerator;
import com.ndpmedia.rocketmq.lsr.paxos.idgen.ViewEpochIdGenerator;
...
public class NioClientProxy implements ClientProxy {
    ...
    private class InitializePacketHandler implements PacketHandler {
        ...
        public void finished() {
            ...
            if (b == com.ndpmedia.rocketmq.lsr.paxos.client.Client.REQUEST_NEW_ID) {
            ...
            } else if (b == com.ndpmedia.rocketmq.lsr.paxos.client.Client.HAVE_CLIENT_ID) {
                ...
                logger.error(
                        ...
                        com.ndpmedia.rocketmq.lsr.paxos.client.Client.REQUEST_NEW_ID,
                        com.ndpmedia.rocketmq.lsr.paxos.client.Client.HAVE_CLIENT_ID, b);
