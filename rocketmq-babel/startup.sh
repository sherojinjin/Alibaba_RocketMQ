...
JAVA_OPTS=" -Duser.timezone=GMT+8 -server -Xms512m -Xmx512m -Xloggc:$APP_LOG/logs/producerServer.gc.log -Denable_ssl=true -DRocketMQClientPassword=4R4MNv54OnDeoHSRnngFkA== -Dlog.home=$APP_LOG "
